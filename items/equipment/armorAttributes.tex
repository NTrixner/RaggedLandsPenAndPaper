\subsection{Armor Attributes}\label{subsec:armorAttributes}
...
\subsubsection{Flammable}\label{armor:flammable}
...
\subsubsection{Magic Defense}\label{armor:magicDefense}
