...
If the character then decides to actively search for this specific trap, they roll a \ref{sec:examination} check contested by the Trap's Find DV. If they find the trap, they can then attempt to disable it by making a \nameref{sec:trapHandling} check contested by the Trap's Trap Handling DV.\\
