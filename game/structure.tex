\chapter{Adventure Structure}\label{ch:adventuringStructure}
...
\section{Combat, Adventuring and Social.}\label{sec:gameModes}
\begin{itemize}
...
\section{Gaining CP}\label{sec:gainingCP}
