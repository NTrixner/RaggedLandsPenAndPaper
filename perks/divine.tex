...
This means that a character with 10 Piety would be able to equip~\nameref{prayer:divinePunishment},~\nameref{prayer:divineRest} and~\nameref{prayer:thornShot}.\\
...
If a character knows the perk of a Wonder, they can use it whenever they like.\\
	...
	\input{./perks/divine/divinedisciple.tex}
	
	\input{./perks/divine/prayers/beaconoflight.tex}
	
	\input{./perks/divine/prayers/deathburst.tex}
	
	\input{./perks/divine/prayers/divineenhancement.tex}

	\input{./perks/divine/prayers/divinepower.tex}

	\input{./perks/divine/prayers/divinepunishment.tex}
	
	\input{./perks/divine/prayers/divinerest.tex}
	
	\input{./perks/divine/prayers/thornshot.tex}
	
	\input{./perks/divine/prayers/truebalance.tex}
	
	
	%Wonders
	
	\input{./perks/divine/wonders/divinesalvation.tex}
	
	\input{./perks/divine/wonders/divinerejuvination.tex}
	
	\input{./perks/divine/wonders/divinefury.tex}
