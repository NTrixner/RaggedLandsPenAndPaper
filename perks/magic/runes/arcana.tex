...
Make an IN check.
This targets the dodge of any creature in a radius of \passus{3} around your chosen point.
...
If the fail on the Strength check, they are pushed \passus{1} away from the point of origin of the blast, and fall prone.
