...
Additionally, it can now carry up to 10 coin-sized objects.
However, while carrying such objects it requires an additional 1 Mana per AP spent on movement.
...
Make an IN check targeting their notice.
If your check is above their maximum notice, they become blinded for 1D4 + 2 AP.
If they roll against your IN check and succeed, that duration is halved.
