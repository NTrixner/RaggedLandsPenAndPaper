...
Choose a pool value.
Whenever you gain a rank in the "Increase" Perk for that pool value (\nameref{perk:increasehealth}, \nameref{perk:increasestamina}, and \nameref{perk:increasemana}), the amount of points you gain is increased by one die size (from 1d6 to 1d8 to 1d10 to a maximum of 1d12).
