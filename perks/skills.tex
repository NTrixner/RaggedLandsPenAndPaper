...
\input{./perks/skills/animalHandling.tex}

\input{./perks/skills/balancing.tex}

\input{./perks/skills/climbing.tex}

\input{./perks/skills/deception.tex}

\input{./perks/skills/examination.tex}

\input{./perks/skills/forgery.tex}

\input{./perks/skills/intimidation.tex}

\input{./perks/skills/jumping.tex}

\input{./perks/skills/lockPicking.tex}

\input{./perks/skills/lore.tex}

\input{./perks/skills/masquerade.tex}

\input{./perks/skills/medicine.tex}

\input{./perks/skills/negotiation.tex}

\input{./perks/skills/performance.tex}

\input{./perks/skills/pickpocket.tex}

\input{./perks/skills/research.tex}

\input{./perks/skills/ropeHandling.tex}

\input{./perks/skills/seduction.tex}

\input{./perks/skills/stealth.tex}

\input{./perks/skills/survival.tex}

\input{./perks/skills/swimming.tex}

\input{./perks/skills/trapHandling.tex}